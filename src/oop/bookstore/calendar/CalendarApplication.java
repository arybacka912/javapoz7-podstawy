...
import oop.bookstore.calendar.CalendarDays;
import oop.bookstore.calendar.CalendarMonth;
...
public class CalendarApplication {
    ...
    private static void showNote(Scanner scanner, CalendarMonth calendarMonth) {
        ...
        CalendarDays calendarDay = calendarMonth.getCalendarDay(numberOfDayToShow);
